...
fn char_to_number(caracter : char)->Result<char,Error>{
...
fn print_error(eroare :Error){
    if eroare == Error::CharacterIsNotAscii {
        println!("Caracterul introdus nu este Ascii / Nu apartine intervalului numeric (0,127) ...");
    }
...
fn main() {
   ...
   print_error_2(char_to_number('1'));
   print_error_2(char_to_number_hex('2'));
